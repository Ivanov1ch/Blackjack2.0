...
public class HowToPlay {
  public static void main (String[] args){
    ...
    println("After each player has had his turn, the dealer will turn over his hole card. If the dealer has 16 or less, then he will draw another card. If he has an ace and another set of totaling 6 points, it is said that he has a \"Soft 17\". In this casino, the dealer is forced to hit on a soft 17.");
